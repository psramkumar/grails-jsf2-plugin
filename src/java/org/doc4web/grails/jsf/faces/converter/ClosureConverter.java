 ...
 */
public class ClosureConverter implements Converter {
    /**
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        return ((Closure) value).call(args).toString();  //To change body of implemented methods use File | Settings | File Templates.
    }
}
